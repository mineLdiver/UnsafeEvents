...
public class ManagedEventBus extends EventBus {
     ...
     * and a new {@linkplain EventBusController event bus controller} attached to it.
     *
     * <p>
     ...
     * @author mine_diver
     */
    public record WithController(@NotNull ManagedEventBus eventBus, @NotNull EventBusController eventBusController) {}
    ...
    protected static class ControllerImpl implements EventBusController {
        /**
        ...
        /**
         * A throwable containing a stack trace of {@link EventBusController#disableDispatch(String)}
