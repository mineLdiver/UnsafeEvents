...
public class EventBus {
     ...
     */
    @NotNull ListenerRegistryFactory listenerRegistryFactory = new ListenerRegistryFactory(this, MethodHandles.lookup());
     ...
     */
    @NotNull Int2ReferenceMap<@NotNull ListenerContainer @NotNull []> listeners = new Int2ReferenceOpenHashMap<>();
    ...
    @NonFinal @NotNull Consumer<@NotNull Event> @NotNull [] registriesArray = new Consumer[0];
     ...
     * @see Int2ReferenceArrayMapWrapper
     */
    @NotNull Int2ReferenceArrayMapWrapper<@NotNull Consumer<@NotNull Event>> registries = Util.make(new Int2ReferenceArrayMapWrapper<>(
            () -> registriesArray,                                                        // the array getter
            arr -> registriesArray = arr,                                                 // the array setter
            (IntFunction<Consumer<@NotNull Event> @NotNull []>) Consumer[]::new,          // the array constructor
     ...
     */
    @NotNull IntSet invalidatedRegistries = new IntOpenHashSet();
    ...
    public <EVENT extends Event> void register(final @NotNull SingularListener<@NotNull EVENT> listener) {
        val globalId = Event.getEventID(listener.eventType());
        //noinspection unchecked
        val listenerContainer = new ListenerContainer((Consumer<@NotNull Event>) listener.listener(), listener.priority());
    ...
    protected void compileRegistries() {
        invalidatedRegistries.iterator().forEachRemaining(registryId -> {
            val listenerContainers = listeners.get(registryId);
            //noinspection unchecked
            registries.put(
                    registryId,
